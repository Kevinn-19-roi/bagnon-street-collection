  ...
  return (
    <main style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <section style={{ padding: 'clamp(30px,6vw,70px) var(--px)' }}>
        <div className="order-confirmation-grid" style={{ maxWidth: 1120, margin: '0 auto', display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(280px,360px)', gap: 'clamp(22px,4vw,42px)', alignItems: 'start' }}>
          ...
          <aside style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 6, padding: 18, position: 'sticky', top: 82 }}>
            ...
            <div style={{ display: 'grid', gap: 9, color: 'var(--text2)', fontSize: 13, marginBottom: 16 }}>
              <p>Statut : {orderStatusLabels[order.order_status] || order.order_status}</p>
